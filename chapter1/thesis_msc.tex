...
\hypersetup{
    ...
    pdfauthor={Jompoj Wongphechauxsorn},          % AUTHOR
...
\begin{document}
    ...
    \noindent 1. Gutachter: Prof. Dr. Michael Kramer [Supervisor] \\
    \noindent 2. Gutachter: Prof. Dr. Norbert Langer [2nd referee]
    ...
    \subfile{../chapter1/chapter4-5}
    \subfile{../chapter1/chapter6}
    ...
    \bibliography{bibfile_thesis.bib}
    \phantomsection
